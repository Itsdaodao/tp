...
import static seedu.address.logic.commands.CommandTestUtil.NAME_DESC_DEFAULT;
...
public class AddCommandParserTest {
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        assertParseFailure(parser,
                validExpectedPersonString
                        + PHONE_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY + TELEGRAM_DESC_AMY
                        + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(
                        PREFIX_NAME, PREFIX_EMAIL, PREFIX_PHONE, PREFIX_TELEGRAM));
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_DEFAULT + PHONE_DESC_DEFAULT,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB
                        + VALID_EMAIL_BOB + VALID_TELEGRAM_BOB,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + INVALID_TELEGRAM_DESC + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Telegram.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + INVALID_PHONE_DESC
                        + EMAIL_DESC_BOB + TELEGRAM_DESC_BOB,
